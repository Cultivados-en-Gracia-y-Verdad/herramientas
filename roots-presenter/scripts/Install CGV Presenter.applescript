on run
  ...
  try
    ...
    do shell script "xattr -cr " & quoted form of sourceApp
    do shell script "codesign --force --deep --sign - " & quoted form of sourceApp
    ...
    do shell script "codesign --force --deep --sign - " & quoted form of targetApp
