...
| Compiler skeleton | `skeleton/{libro}-manual-skeleton.md` |
| Editorial notes (not student content) | `reports/{libro}-editorial-notes.md` |

Spine: **{OSHB / SBLGNT}**. Alignment: {hand / machine, chapter range}.
...
**Book genre:** {narrative · prophetic vision cycle · epistle · wisdom · apocalyptic-in-the-text's-own-words}
