...
python3 scripts/stage1/update_verification_ledger.py \
  1corintios \
  --date 2026-05-16
...
python3 scripts/stage4/build_predicate_completeness.py 1corintios

python3 scripts/stage4/validate_predicate_completeness.py 1corintios
