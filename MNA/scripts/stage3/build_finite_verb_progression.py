...
VERSION = "stage3-finite-verb-progression-builder-v2-stage2-anchors-only"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Build Stage 3 finite-verb progression observations from Stage 2 anchors.")
    ...
    for idx, anchor in enumerate(anchors, start=1):
        ...
        rows.append({
            ...
            "s_marker": s,
            "m_marker": m,
            "marker_policy": "CONSTRAINED_FINITE_VERB_PROGRESSION_OBSERVATION_FROM_STAGE2_ANCHORS",
        })
        previous = anchor
    ...
    with out_path.open("w", encoding="utf-8") as f:
        f.write(json.dumps({
            ...
            "policy": "STAGE2_ANCHORS_ONLY_NO_TRUNK_NO_UNITS_NO_LABELS_NO_TITLES",
