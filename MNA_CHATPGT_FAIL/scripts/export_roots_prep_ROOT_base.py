...
def detect_clause_intro_start(
    ...
    Important:
    - Greek identifies possible clause-introducing material.
    - NBLA position decides the actual clause start.
    - This is the handoff from Greek/TSV to ROOT base.
    """
    ...
    for _g_idx, row in greek_range_rows(greek_tokens, align_by_gidx, g_start, g_end):
        ...
        # Keep near-introducers such as "a quien", "que", "si", "para que",
        # without dragging earlier Spanish nouns backward into the new clause.
