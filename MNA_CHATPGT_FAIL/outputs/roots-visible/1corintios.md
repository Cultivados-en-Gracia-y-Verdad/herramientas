# ROOTS Vista Estructural — 1corintios
...
```text
C1. ==doy gracias== a mi dios por ustedes por la gracia de dios que les fue dada en cristo jesús
```

## 1corintios 1:5

```text
C1. ==ustedes fueron enriquecidos== en él en toda palabra y en todo conocimiento
```

## 1corintios 1:6

```text
C1. ==fue confirmado== en ustedes
```
...
```text
C1. ==confirmará== hasta el fin para que sean irreprensibles en el día de nuestro señor jesucristo
```

## 1corintios 1:9

```text
C1. ==fueron llamados== a la comunión con su hijo jesucristo nuestro señor
```

## 1corintios 1:10

```text
C1. ==les ruego== hermanos por el nombre de nuestro señor jesucristo que todos
    PURP [ἵνα]
    C2. ==se pongan de acuerdo== y que no
    C3. ==haya== divisiones entre ustedes sino que
    C4. ==estén== enteramente unidos en un mismo sentir y en un mismo parecer
```

## 1corintios 1:11

```text
C1. ==he sido informado== acerca de ustedes hermanos míos por los de cloé que
    CONT [ὅτι]
    C2. ==hay== discusiones entre ustedes
```

## 1corintios 1:12

```text
C1. ==me refiero== a que cada uno de ustedes
    CONT [ὅτι]
    C2. ==dice== yo
C3. ==soy== de pablo otro yo de apolos otro yo de cefas y otro yo de cristo
```

## 1corintios 1:13

```text
C1. ==está dividido== cristo acaso
C2. ==fue crucificado== por ustedes o
C3. ==fueron bautizados== en el nombre de pablo
```

## 1corintios 1:14

```text
C1. ==doy gracias a dios== que no a ninguno
    CONT [ὅτι]
    C2. de ustedes excepto a crispo y a gayo
```
...
C1. ==diga== que
    CONT [ὅτι]
    C2. ==fueron bautizados== en mi nombre
```
...
```text
C1. ==es== necedad para los que se pierden pero para nosotros los salvos
C2. ==es== poder de dios
```
...
```text
C1. ==ha hecho que sea necedad==
```

## 1corintios 1:21

```text
C1. ==conoció== a dios por medio de su propia sabiduría
...
```text
C1. ==piden== señales y los griegos
C2. ==buscan== sabiduría
```
...
```text
C1. ==predicamos== a cristo crucificado piedra de tropiezo para los judíos y necedad para los gentiles
```
...
```text
C1. ==es== más sabia que los hombres y la debilidad de dios es más fuerte que los hombres
```

## 1corintios 1:26

```text
C1. ==consideren== hermanos su llamamiento no hubo muchos sabios conforme a la carne ni muchos poderosos ni muchos nobles
```
...
```text
C1. ==se jacte== delante de dios
```

## 1corintios 1:30

```text
C1. ==están== ustedes en cristo jesús el cual
C2. ==se hizo== para nosotros sabiduría de dios y justificación santificación y redención
```
...
```text
C1. ==fui== con superioridad de palabra o de sabiduría
```

## 1corintios 2:2

```text
C1. ==me propuse== saber entre ustedes excepto a jesucristo y este crucificado
```
...
```text
C1. ==descanse== en la sabiduría de los hombres sino en el poder de dios
```

## 1corintios 2:6

```text
C1. ==hablamos== sabiduría entre los que han alcanzado madurez pero una sabiduría no de este siglo ni de los gobernantes de este siglo que van desapareciendo
```

## 1corintios 2:7

```text
C1. ==hablamos== sabiduría de dios en misterio la sabiduría oculta que desde antes de los siglos dios
C2. ==predestinó== para nuestra gloria
```
...
```text
C1. ==está escrito== cosas que ojo no
C2. ==vio== ni oído
C3. ==oyó== ni
C4. ==han entrado== al corazón del hombre son las cosas que dios
C5. ==ha preparado== para los que lo aman
```

## 1corintios 2:10

```text
C1. ==las reveló== por medio del espíritu porque el espíritu todo
...
```text
C1. ==hablamos== no con palabras enseñadas por sabiduría humana sino con las enseñadas por el espíritu combinando pensamientos espirituales con palabras espirituales
```
...
```text
C1. ==ha conocido== la mente del señor para que lo
C2. ==instruya== pero nosotros
C3. ==tenemos== la mente de cristo
```

## 1corintios 3:1

```text
C1. ==pude== hablarles como a espirituales sino como a carnales como a niños en cristo
```

## 1corintios 3:2

```text
C1. ==di a beber== leche no alimento sólido porque todavía no
...
```text
C1. ==son== carnales pues habiendo celos y discusiones entre ustedes no
C2. ==son== carnales y
C3. ==andan== como hombres del mundo
```
...
```text
C1. ==dice== yo
C2. ==soy== de pablo y otro yo soy de apolos no
C3. ==son== como hombres del mundo
```

## 1corintios 3:5

```text
C1. ==es== pues apolos y qué
C2. ==es== pablo servidores mediante los cuales
C3. ==ustedes han creído== según el señor
C4. ==dio oportunidad== a cada uno
```
...
```text
C1. ==es== algo sino dios que da el crecimiento
```
...
```text
C1. ==somos== colaboradores en la labor de dios
C2. ==y ustedes son== el campo de cultivo de dios el edificio de dios
```

## 1corintios 3:10

```text
C1. ==puse== el fundamento y otro
C2. ==edifica sobre él== pero cada uno
C3 [IMP]. ==tenga cuidado== cómo
C4. ==edifica encima==
```
...
```text
C1. ==puede== poner otro fundamento que el que ya está puesto el cual
C2. ==es== jesucristo
```
...
```text
C1. ==edifica== con oro plata piedras preciosas madera heno paja
```
...
```text
C1. ==es consumida por el fuego==
C2. ==sufrirá pérdida== sin embargo él
C3. ==será salvo== aunque así como a través del fuego
```
...
```text
C1. ==destruye== el templo de dios dios
C2. ==lo destruirá== a él porque el templo de dios
C3. ==es== santo y eso es lo que ustedes
C4. ==son==
```
...
```text
C1 [IMP]. ==se engañe== a sí mismo si alguien de ustedes
C3 [IMP]. ==hágase== necio a fin de
    COND [εἰ]
    C2. ==se cree== sabio según este mundo
    PURP [ἵνα]
    C4. ==llegar a ser== sabio
```

## 1corintios 3:19

```text
C1. ==es== necedad ante dios pues
C2. ==escrito está== él es el que prende a los sabios en su propia astucia
```

## 1corintios 3:20

```text
C1. ==conoce== los razonamientos de los sabios los cuales
    CONT [ὅτι]
    C2. ==son== inútiles
```
...
C1. ==distingue== qué
C2. ==tienes== que no
C3. ==recibiste== y si lo
C4. ==recibiste== por qué
...
```text
C1. ==están== saciados ya
C2. ==se han hecho ricos ya==
C3. ==han llegado a reinar== sin necesidad de nosotros ojalá
C4. ==hubieran llegado a reinar== para que nosotros
    PURP [ἵνα]
    C5. ==reináramos== también con ustedes
```

## 1corintios 4:9

```text
C1. ==pienso que== dios nos
C2. ==ha exhibido a== nosotros los apóstoles en último lugar como a sentenciados a muerte porque
    CONT [ὅτι]
    C3. ==hemos llegado a ser== un espectáculo para el mundo tanto para los ángeles como para los hombres
```
...
```text
C1. ==tratamos de reconciliar==
C2. ==hemos llegado a ser== hasta ahora la basura del mundo el desecho de todo
```

## 1corintios 4:14

```text
C1. ==escribo== esto para avergonzarlos sino para amonestarlos como a hijos míos amados
```

## 1corintios 4:15

```text
C1. ==tengan== innumerables maestros en cristo sin embargo no tienen muchos padres pues en cristo jesús yo los
C2. ==engendré== por medio del evangelio
```
...
```text
C1. ==he enviado== a timoteo que
C2. ==es== mi hijo amado y fiel en el señor él les
C3. ==recordará== mis caminos los caminos en cristo tal como
C4. ==yo enseño== en todas partes en cada iglesia
```

## 1corintios 4:18

```text
C1. ==se han vuelto arrogantes== como si yo no hubiera de ir a verlos
```
...
```text
C1. ==quieren==
C2. ==iré== a ustedes con vara o con amor y espíritu de mansedumbre
```
...
```text
C1 [IMP]. ==limpien== la levadura vieja para que
    PURP [ἵνα]
    C2. ==sean== masa nueva así como
    C3. ==lo son en realidad== sin levadura porque aun cristo nuestra pascua
    C4. ==ha sido sacrificado==
```

## 1corintios 5:8

```text
C1. ==celebremos la fiesta== no con la levadura vieja ni con la levadura de malicia y maldad sino con panes sin levadura de sinceridad y de verdad
```

## 1corintios 5:9

```text
C1. ==escribí== que no anduvieran en compañía de personas inmorales
```
...
```text
C1. ==escribí== que no anduvieran en compañía de ninguno que llamándose hermano
    CONT [implícito]
    C2. ==es una persona== inmoral o avaro o idólatra o difamador o borracho o estafador con esa persona ni siquiera coman
```

## 1corintios 5:12

```text
C1. ==juzgan== ustedes a los que están dentro de la iglesia
```

## 1corintios 5:13

```text
C1. ==juzga== a los que están fuera
C2 [IMP]. ==expulsen== al malvado de entre ustedes
```

## 1corintios 6:1

```text
C1. ==se atreve== alguno de ustedes cuando tiene algo contra su prójimo a ir a juicio ante los incrédulos y no ante los santos
```
...
```text
C1. ==tienen== tribunales
C2. ==que juzgan los casos por qué ponen por jueces== a los que nada son en la iglesia
```
...
```text
C1. ==son lícitas== pero no todas
C2. ==son de provecho== todas las cosas me
C3. ==son lícitas== pero yo no
...
```text
C1. ==destruirá== a los dos sin embargo el cuerpo no es para la fornicación sino para el señor y el señor es para el cuerpo
```

## 1corintios 6:14

```text
C1. ==que resucitó== al señor también nos a nosotros
C2. mediante su poder
```
...
```text
C1 [IMP]. ==huyan== de la fornicación todos los demás pecados que un hombre
C2. ==comete==
C3. ==están== fuera del cuerpo pero el fornicario
C4. ==peca== contra su propio cuerpo
```
...
```text
C1. ==han sido comprados== por un precio por tanto
C2 [IMP]. ==glorifiquen== a dios en su cuerpo y en su espíritu los cuales son de dios
```

## 1corintios 7:1

```text
C1. ==me escribieron== bueno es para el hombre no tocar mujer
```

## 1corintios 7:2

```text
C1 [IMP]. ==tenga== su propia mujer y cada una
C2 [IMP]. ==tenga== su propio marido
```

## 1corintios 7:3

```text
C1 [IMP]. ==que cumpla== su deber para con su mujer e igualmente la mujer lo cumpla con el marido
```

## 1corintios 7:4

```text
C1. ==tiene autoridad== sobre su propio cuerpo sino el marido y asimismo el marido no
C2. ==tiene autoridad== sobre su propio cuerpo sino la mujer
```

## 1corintios 7:5

```text
C1 [IMP]. ==se priven== el uno del otro excepto de común acuerdo y por cierto tiempo para
    PURP [ἵνα]
    C2. ==dedicarse== a la oración
    C3. ==vuelvan== después a juntarse a fin de que satanás no los
        PURP [ἵνα]
        C4. ==tiente== por causa de falta de dominio propio
```

## 1corintios 7:6

```text
C1. ==digo== por vía de concesión no como una orden
```

## 1corintios 7:7

```text
C1. ==yo desearía== que fueran como yo no obstante cada cual
C2. ==ha recibido== de dios su propio don unos de una manera y otros de otra
```

## 1corintios 7:8

```text
C1. ==digo== que es bueno para ellos si
    CONT [implícito]
    C2. ==se quedan== como yo
```

## 1corintios 7:9

```text
C2 [IMP]. ==cásense que== mejor
    COND [εἰ]
    C1. ==carecen de dominio propio==
...
```text
C1. ==instruyo== no yo sino el señor que la mujer no debe debe dejar al marido
```
...
```text
C1. ==digo== yo no el señor que si un hermano
C4 [IMP]. ==abandone==
    COND [εἰ ... ἢ]
    C2. ==tiene== una mujer que no es creyente y ella
    C3. ==consiente en== vivir con él no la
```
...
```text
C1. ==es santificado== por medio de su mujer y la mujer que no es creyente
C2. ==es santificada== por medio de su marido creyente de otra manera sus hijos
C3. ==serían== inmundos pero ahora
C4. ==son== santos
```
...
```text
C1. ==es== y nada
C2. ==es== la incircuncisión sino el guardar los mandamientos de dios
```
...
```text
C1. ==llamado== siendo esclavo
C2 [IMP]. ==no== te preocupes aunque si
C4 [IMP]. ==prefiérelo==
    COND [εἰ]
    C3. ==puedes== obtener tu libertad
```

## 1corintios 7:22

```text
C1. ==es== del señor de la misma manera el que fue llamado siendo libre esclavo
C2. ==es== de cristo
```
...
```text
C1. ==creo== pues que esto es bueno en vista de la presente aflicción es decir que es bueno que el hombre se quede como está
```
...
C2 [IMP]. ==procures== separarte
C3. ==estás libre== de mujer no
C4 [IMP]. ==busques== mujer
```
...
```text
C1. ==digo== hermanos el tiempo ha
C2. ==sido== acortado de modo que de ahora en adelante los que tienen mujer
    PURP [ἵνα]
    C3. ==sean si== no la tuvieran
```
...
```text
C1. ==preocupa== por las cosas del mundo de cómo
...
```text
C1. ==intereses== están divididos la mujer que no está casada y la virgen se
C2. ==preocupan== por las cosas del señor para ser
    PURP [ἵνα]
    C3. ==santas== tanto en cuerpo como en espíritu pero la casada se preocupa por las
...
```text
C5 [IMP]. ==que haga== lo que
    COND [εἰ ... ἢ]
    C1. ==cree que== no está obrando correctamente con respecto a su hija virgen si
    C2. ==ella es== de edad madura y si
    C3. ==es necesario== que se haga
    C4. ==quiera== no
C6. ==peca==
C7 [IMP]. ==que se case==
```
...
```text
C1. ==hace== bien y el que no la da en matrimonio
C2. ==hace== mejor
```
...
```text
C1. ==será== más feliz si
C2. ==se queda== como está y
C3. ==creo== que yo también tengo el espíritu de dios
```
...
```text
C1. ==cree que== sabe algo no todavía
C2. como
C3. ==debe== saber
```
...
```text
C1. ==llamados== dioses ya sea en el cielo o en la tierra como por cierto
...
```text
C1. ==pero la comida no nos recomendará a dios==
...
```text
C1 [IMP]. ==pero tengan cuidado no sea que esta libertad de ustedes de alguna manera se convierta en piedra de tropiezo para el débil==
...
```text
C1. ==y herir su conciencia cuando esta es débil pecan contra cristo==
```

## 1corintios 8:13

```text
C1. ==por tanto si la comida hace que mi hermano caiga en pecado==
...
```text
C1. ==derecho== a comer y beber
```

## 1corintios 9:5

```text
C1. ==derecho== a llevar con nosotros una esposa creyente así como los demás apóstoles y los hermanos del señor y cefas
```
...
```text
C1. ==hago esto voluntariamente==
C2. ==tengo recompensa== pero si lo hago en contra de mi voluntad
C3. ==un encargo se me ha confiado==
```

## 1corintios 9:18

```text
C1. ==mi== recompensa que al predicar el evangelio pueda ofrecerlo
    PURP [ἵνα]
    C2. ==gratuitamente== sin hacer pleno uso de mi derecho como predicador del evangelio
```

## 1corintios 9:19

```text
C1. ==de todos me he hecho esclavo==
    PURP [ἵνα]
...
```text
C1. ==para poder ganar a los que están sin ley==
```
...
```text
C1. ==y todo el que compite en los juegos se abstiene de todo==
    PURP [ἵνα]
...
```text
C1. ==por tanto yo de esta manera corro== no como sin tener meta
C2. ==de esta manera peleo no como dando golpes al aire==
```
...
```text
C1 [IMP]. ==por tanto el que cree que está firme tenga cuidado no sea que caiga==
...
```text
C1 [IMP]. ==por tanto amados míos huyan== de la idolatría
```
...
C2 [IMP]. ==les hablo como a sabios juzguen ustedes lo que digo==
...
```text
C1 [IMP]. ==consideren== al pueblo de israel los que comen los sacrificios no participan del
C2. ==altar==
```
...
```text
C1 [IMP]. ==nadie busque su propio bien sino el de su prójimo==
```

## 1corintios 10:25

```text
C1 [IMP]. ==coman de todo lo que se vende en la carnicería sin preguntar nada por motivos de conciencia==
```
...
```text
C3 [IMP]. ==si algún incrédulo los invita y quieren ir coman de todo lo que se les ponga delante sin preguntar nada por motivos de conciencia==
    COND [εἰ ... ἢ]
...
C3 [IMP]. ==pero si alguien les dice esto ha sido sacrificado a los ídolos no lo coman por causa del que se lo dijo y por motivos de conciencia porque del señor es la tierra y todo lo que en ella hay==
```
...
C4 [IMP]. ==entonces ya sea que coman que beban o que hagan cualquier otra cosa háganlo todo para la gloria de dios==
```
...
```text
C1. ==pero quiero== que sepan que la cabeza de todo hombre
    CONT [ὅτι]
    C2. ==es== cristo y la cabeza de la mujer es el hombre y la cabeza de cristo es dios
```

## 1corintios 11:4

```text
C1. ==deshonra== su cabeza
```

## 1corintios 11:5

```text
C1. ==deshonra== su cabeza porque se
...
```text
C1. ==debe cubrirse== la cabeza ya que él es la imagen y gloria de dios pero la mujer
C2. ==es la== gloria del hombre
```

## 1corintios 11:8

```text
C1. ==procede== de la mujer sino la mujer del hombre
```

## 1corintios 11:9

```text
C1. ==fue creado== a causa de la mujer sino la mujer a causa del hombre
```

## 1corintios 11:10

```text
C1. ==debe tener== un símbolo de autoridad sobre la cabeza por causa de los ángeles
```
...
```text
C1. ==enseña== la la misma misma naturaleza que si el hombre
    CONT [ὅτι]
    C2. ==tiene el cabello largo== le
C3. ==es== deshonra
```
...
```text
C1. ==tiene el cabello largo==
C2. ==le es== una gloria pues a ella el cabello le
    CONT [ὅτι]
    C3. ==es dado== por velo
```
...
```text
C1. ==los alabo== porque no
    CONT [ὅτι]
    C2. ==se congregan== para lo bueno sino para lo malo
```

## 1corintios 11:18

```text
C1. ==reúnen== como iglesia hay divisiones entre ustedes y en parte lo
C2. ==creo==
```
...
C1. ==partió== y
C2. ==dijo== esto es
C3. mi cuerpo que ==es== para ustedes
C4 [IMP]. ==hagan== esto en en memoria de mí
```

## 1corintios 11:25

```text
C1. ==es== el nuevo pacto en mi sangre
C2 [IMP]. ==hagan== esto cuantas veces
C3. ==la beban== en en memoria de mí
```
...
C1. ==coman== este pan y
C2. ==beban== esta copa
C3. ==proclaman== la muerte del señor hasta que él
C4. ==venga==
```
...
```text
C1. ==tanto== les hago saber que nadie hablando por el espíritu de dios dice
    CONT [ὅτι]
    C2. ==jesús== es anatema y nadie puede
C3. ==decir== jesús es el señor excepto por el espíritu santo
```
...
```text
C1. ==operaciones== pero es el mismo dios el que hace todas las cosas en todos
```
...
```text
C1. ==es== uno y
C2. ==tiene== muchos miembros pero todos los miembros del cuerpo aunque son muchos
C3. ==constituyen== un solo cuerpo así también es cristo
```

## 1corintios 12:13

```text
C1. ==judíos== o griegos ya esclavos o libres a todos todos se nos
C2. ==dio a beber del== mismo espíritu
```

## 1corintios 12:14

```text
C1. ==solo== miembro sino muchos
```
...
```text
C1. ==son los== más necesarios
```

## 1corintios 12:23

```text
C1. ==que estimamos== menos honrosas a estas
C2. ==las vestimos== con más honra así que las partes que consideramos más íntimas
C3. ==reciben== un trato más honroso
```

## 1corintios 12:24

```text
C1. no ==no lo== necesitan pero así formó
C2. ==dios== el cuerpo dando mayor honra a la parte que carecía de ella
```

## 1corintios 12:25

```text
C1. ==haya== división sino que los miembros
C2. ==tengan cuidado unos== por otros
```
...
```text
C1. ==ustedes son== el cuerpo de cristo y cada uno individualmente un miembro de él
```
...
```text
C1. ==tienen== todos dones de sanidad acaso
C2. ==hablan== todos en lenguas acaso
C3. ==interpretan== todos
```
...
```text
C1. ==habla a== los hombres sino a dios pues nadie
C2. ==lo entiende== sino que en su espíritu
C3. ==habla== misterios
```
...
```text
C1. ==se edifica== pero el que profetiza
C2. ==edifica a== la iglesia
```

## 1corintios 14:5

```text
C1. ==yo quisiera== que todos hablaran en lenguas pero aún más que profetizaran porque el que
    PURP [ἵνα]
...
```text
C1. ==yo voy== a ustedes hablando en lenguas
C2. ==de provecho seré a== menos de que les
C3. ==hable== por medio de revelación o de conocimiento o de profecía o de enseñanza
```

## 1corintios 14:7

```text
C1. ==dan== con distinción los sonidos cómo
...
```text
C1. ==idiomas== en el mundo y ninguno carece de significado
```
...
```text
C1. ==hablar cinco== palabras con mi entendimiento para instruir también a otros antes que diez mil
    PURP [ἵνα]
    C2. ==palabras== en lenguas
```
...
```text
C1. ==habla== en lenguas que hablen dos o a tres y por turno y que uno
C2 [IMP]. ==interprete==
```
...
```text
C1. ==es== dios de confusión sino de paz como en todas las iglesias de los santos
```
...
```text
C2 [IMP]. ==pregunten== a sus propios maridos en casa porque porque no es
    COND [εἰ]
    C1. algo ==algo que==
...
```text
C2 [IMP]. ==reconozca== que lo que les
    COND [εἰ ... ἢ]
    C1. ==alguien piensa== que es profeta o espiritual
C3. ==escribo== es
    CONT [ὅτι]
    C4. ==mandamiento== del señor
```
